...
export default function SanctuaryWorldPage() {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-[#1a1f2e] border border-[#2a2f3e] rounded-lg p-4" style={{boxShadow: '0 0 10px rgba(255, 0, 204, 0.5), 0 0 20px rgba(255, 0, 204, 0.3)'}}>
                ...
                <h3 className="text-xl font-bold text-[#ff00cc] mb-2">Digital Identity Drops</h3>
                <p className="text-[#7a7f8e]">
                  Discover approved digital identity packs, emotes, backgrounds, and glow treatments for your Sanctuary profile.
                </p>
              </div>
            </div>
          </div>
